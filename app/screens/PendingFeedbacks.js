...
class PendingFeedbacks extends Component {
  constructor(props) {
    super(props);
    this.state = {
      feedbackList: [],
  ...
  async fetchFeedbacks() {
    return Utils.makeApiRequest(
      `${this.props.appData.id}?status=pending`,
      {
...
export default connect(mapStateToProps, mapDispatchToProps)(PendingFeedbacks);
